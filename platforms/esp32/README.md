...
```bash
cd platforms/esp32/apps/memfault_demo_app && platforms/esp32/esp-idf/tools/idf.py build
```
...
```bash
cd platforms/esp32/apps/memfault_demo_app && platforms/esp32/esp-idf/tools/idf.py -p <ftdi port, i.e -p ftdi://ftdi:2232/2> flash
```
...
paste it into `esp32/apps/memfault_demo_app/main/config.c`, replacing
...
`/path/to/platforms/esp32/apps/memfault_demo_app/build/memfault-esp32-demo-app.elf`
