...
struct esp_http_client {
    ...
    esp_http_request_body_cb    request_body_handler;
};
...
esp_err_t esp_http_client_perform(esp_http_client_handle_t client)
{
    ...
    do {
        ...
        if (client->request_body_handler && client->post_len) {
            client->request_body_handler(client);
        } else if (client->post_data && client->post_len) {
                                                   ...
                                                   size_t request_body_len)
{
    ...
    client->post_len = request_body_len;
    client->request_body_handler = handler;
    return 0;
}
