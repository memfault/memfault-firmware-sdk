...
static const struct gapm_configuration user_gapm_conf = {
  ...
  .irk = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e,
           0x0f },
  ...
  /// +-----+-----+----+-----+-----+----+----+----+
  /// - Bit [0-1]: Device Name write permission requirements for peer device (@see
  /// device_name_write_perm)
  /// - Bit [2-3]: Device Appearance write permission requirements for peer device (@see
  /// device_appearance_write_perm)
