...
static void system_init(void *pvParameters) {
  ...
  OS_TASK_CREATE("CLI", cli_task, NULL, 1024 * OS_STACK_WORD_SIZE, OS_TASK_PRIORITY_NORMAL, task_h);
  OS_ASSERT(task_h);
...
int main(void) {
  ...
  status = OS_TASK_CREATE("SysInit", system_init, (void *)0, 1024 * OS_STACK_WORD_SIZE,
