...
This application includes an option to send Memfault data over MQTT. This option
requires a few extra pieces to set up. You can either follow the steps outlined
here or use your own MQTT setup.

### Broker Setup

1. Install a local installation of Cedalo by following the
   [installation guide](https://docs.cedalo.com/management-center/installation/)
...
1. Modify the script found in
   [Docs->Best Practices->MQTT](https://docs.memfault.com/docs/best-practices/mqtt-with-memfault#service-examples)
   with Memfault with the following:
...
1. Make the following modifications to `main/app_memfault_transport_mqtt.c`:
   ...
   2. Update `s_mqtt_config` with your setup's IP address, and MQTT client
