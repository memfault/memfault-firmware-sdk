...
//!    python $MEMFAULT_FIRMWARE_SDK/scripts/fw_build_id.py <path to elf file (ends in .axf, .elf,
//!    .out)>
//!
...
//!
//!  This mode makes use of the GNU Build ID generated by the GNU linker
//!  (https://mflt.io/gnu-build-id). If you are compiling with GCC, we _recommend_ using this mode.
//!  To do this, you will need to make the following two changes:
//!
