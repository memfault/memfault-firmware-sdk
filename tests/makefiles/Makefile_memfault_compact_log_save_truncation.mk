...
TEST_SRC_FILES = \
  $(MFLT_TEST_SRC_DIR)/test_memfault_compact_log_save_truncation.cpp \
  $(MOCK_AND_FAKE_SRC_FILES)

CPPUTEST_CPPFLAGS += -DMEMFAULT_COMPACT_LOG_ENABLE=1
CPPUTEST_CPPFLAGS += -DMEMFAULT_LOG_EXPORT_CHUNK_MAX_LEN=10

# Use a small max line save length to easily trigger truncation
CPPUTEST_CPPFLAGS += -DMEMFAULT_LOG_MAX_LINE_SAVE_LEN=32
