...
static void prv_run_capture_test(void *pc, void *lr, int32_t *status_code, size_t storage_size,
...
TEST(MfltTraceEvent, Test_CaptureOk_PcAndLr) {
  ...
  const uint8_t expected_data[] = {
    0xA7, 0x02, 0x02, 0x03, 0x01, 0x07, 0x69, 0x44, 0x41, 0x41, 0x42, 0x42, 0x43, 0x43,
    0x44, 0x44, 0x0A, 0x64, 0x6D, 0x61, 0x69, 0x6E, 0x09, 0x65, 0x31, 0x2E, 0x32, 0x2E,
    0x33, 0x06, 0x66, 0x65, 0x76, 0x74, 0x5F, 0x32, 0x34, 0x04, 0xA3, 0x06, 0x03, 0x02,
    0x1A, 0x12, 0x34, 0x56, 0x78, 0x03, 0x1A, 0xAA, 0xBB, 0xCC, 0xDD,
  };
...
TEST(MfltTraceEvent, Test_CaptureOk_PcAndLrAndStatus) {
  ...
  const uint8_t expected_data[] = { 0xA7, 0x02, 0x02, 0x03, 0x01, 0x07, 0x69, 'D',  'A',  'A',
                                    'B',  'B',  'C',  'C',  'D',  'D',  0x0A, 0x64, 'm',  'a',
                                    'i',  'n',  0x09, 0x65, '1',  '.',  '2',  '.',  '3',  0x06,
                                    0x66, 'e',  'v',  't',  '_',  '2',  '4',  0x04, 0xA4, 0x06,
                                    0x03, 0x02, 0x1A, 0x12, 0x34, 0x56, 0x78, 0x03, 0x1A, 0xAA,
                                    0xBB, 0xCC, 0xDD, 0x07, 0x20 };
...
TEST(MfltTraceEvent, Test_CaptureOk_PcAndLrAndLog) {
  ...
  const uint8_t expected_data[] = { 0xA7, 0x02, 0x02, 0x03, 0x01, 0x07, 0x69, 'D',  'A',  'A',
                                    ...
                                    0x66, 'e',  'v',  't',  '_',  '2',  '4',  0x04, 0xA4, 0x06,
                                    0x03, 0x02, 0x1A, 0x12, 0x34, 0x56, 0x78, 0x03, 0x1A, 0xAA,
                                    0xBB, 0xCC, 0xDD, 0x08, 0x4E, '1',  '2',  '3',  '4',  '5',
                                    '6',  '7',  '8',  '9',  'a',  'b',  'c',  'd',  'e' };
  ...
  for (size_t i = 1; i <= sizeof(expected_data); i++) {
    ...
    rv = memfault_trace_event_with_log_capture(kMfltTraceReasonUser_test, pc, lr,
                                               "%d%d%d%d%d%d789abcdetruncated", 1, 2, 3, 4, 5, 6);
...
TEST(MfltTraceEvent, Test_CaptureOk_PcAndLrAndCompactLog) {
  ...
  const uint8_t expected_data[] = {
    0xA7, 0x02, 0x02, 0x03, 0x01, 0x07, 0x69, 'D',  'A',  'A',  'B',  'B',  'C',  'C',
    'D',  'D',  0x0A, 0x64, 'm',  'a',  'i',  'n',  0x09, 0x65, '1',  '.',  '2',  '.',
    '3',  0x06, 0x66, 'e',  'v',  't',  '_',  '2',  '4',  0x04, 0xA3, 0x06, 0x03, 0x03,
    0x1A, 0xAA, 0xBB, 0xCC, 0xDD, 0x09, 0x84, 0x08, 0x01, 0x02, 0x03,
  };
  ...
  for (size_t i = 1; i <= sizeof(expected_data); i++) {
    ...
    rv = memfault_trace_event_with_compact_log_capture(kMfltTraceReasonUser_test, lr, 0x40, 8, 1, 2,
                                                       3);
...
TEST(MfltTraceEvent, Test_CaptureOk_LrOnly) {
  ...
  const uint8_t expected_data[] = {
    0xA7, 0x02, 0x02, 0x03, 0x01, 0x07, 0x69, 0x44, 0x41, 0x41, 0x42, 0x42, 0x43, 0x43, 0x44,
    0x44, 0x0A, 0x64, 0x6D, 0x61, 0x69, 0x6E, 0x09, 0x65, 0x31, 0x2E, 0x32, 0x2E, 0x33, 0x06,
    0x66, 0x65, 0x76, 0x74, 0x5F, 0x32, 0x34, 0x04, 0xA2, 0x06, 0x03, 0x03, 0x01,
  };
