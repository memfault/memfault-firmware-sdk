...
TEST(MfltRebootTrackingSerializer, Test_Serialize) {
  const uint8_t expected_data_all[] = {
    ...
    0x66, 0x65, 0x76, 0x74, 0x5f, 0x32, 0x34, 0x04, 0xa5, 0x01, 0x19, 0x80, 0x01, 0x02, 0x1a,
    0x0b, 0xad, 0xca, 0xfe, 0x03, 0x1a, 0xde, 0xad, 0xbe, 0xef, 0x04, 0x1a, 0x12, 0x34, 0x56,
    0x78, 0x05, 0x00
  };
  ...
  const uint8_t expected_data_pc_lr[] = {
    0xa7, 0x02, 0x02, 0x03, 0x01, 0x07, 0x69, 0x44, 0x41, 0x41, 0x42, 0x42, 0x43, 0x43, 0x44, 0x44,
    0x0a, 0x64, 0x6d, 0x61, 0x69, 0x6e, 0x09, 0x65, 0x31, 0x2e, 0x32, 0x2e, 0x33, 0x06, 0x66, 0x65,
    0x76, 0x74, 0x5f, 0x32, 0x34, 0x04, 0xa4, 0x01, 0x19, 0x80, 0x01, 0x02, 0x1a, 0x0b, 0xad, 0xca,
    0xfe, 0x03, 0x1a, 0xde, 0xad, 0xbe, 0xef, 0x05, 0x00
  };
  ...
  const uint8_t expected_data_pc[] = {
    0xa7, 0x02, 0x02, 0x03, 0x01, 0x07, 0x69, 0x44, 0x41, 0x41, 0x42, 0x42, 0x43, 0x43, 0x44, 0x44,
    0x0a, 0x64, 0x6d, 0x61, 0x69, 0x6e, 0x09, 0x65, 0x31, 0x2e, 0x32, 0x2e, 0x33, 0x06, 0x66, 0x65,
    0x76, 0x74, 0x5f, 0x32, 0x34, 0x04, 0xa3, 0x01, 0x19, 0x80, 0x01, 0x02, 0x1a, 0x0b, 0xad, 0xca,
    0xfe, 0x05, 0x00
  };
  ...
  const uint8_t expected_data_no_optionals[] = {
    0xa7, 0x02, 0x02, 0x03, 0x01, 0x07, 0x69, 0x44, 0x41, 0x41, 0x42, 0x42, 0x43, 0x43, 0x44, 0x44,
    0x0a, 0x64, 0x6d, 0x61, 0x69, 0x6e, 0x09, 0x65, 0x31, 0x2e, 0x32, 0x2e, 0x33, 0x06, 0x66, 0x65,
    0x76, 0x74, 0x5f, 0x32, 0x34, 0x04, 0xa2, 0x01, 0x19, 0x80, 0x01, 0x05, 0x01
  };
...
TEST(MfltRebootTrackingSerializer, Test_GetWorstCaseSerializeSize) {
  ...
  LONGS_EQUAL(63, worst_case_size);
}
