...
TEST(MemfaultMetricsSerializer, Test_MemfaultMetricSerialize) {
  ...
  const uint8_t expected_serialization[] = {
    0xa6, 0x02, 0x01, 0x03, 0x01, 0x0a, 0x64, 'm',  'a',  'i',
    'n',  0x09, 0x65, '1',  '.',  '2',  '.',  '3',  0x06, 0x66,
    'e',  'v',  't',  '_',  '2',  '4',  0x04, 0xa2, 0x02, MEMFAULT_METRICS_SESSION_KEY(heartbeat),
    0x01, 0x86, 0x19, 0x03, 0xe8, 0xf6, 0x39, 0x03, 0xe7, 0xf6,
    0x19, 0x04, 0xd2, 0x6e, '1',  '2',  '3',  '4',  '5',  '6',
    '7',  '8',  '9',  'a',  'b',  'c',  'd',  'e'
  };
