...
static void prv_encode_metadata_and_check(sMemfaultCborEncoder *e, void *result,
  ...
  for (size_t i = 1; i <= expected_size; i++) {
    ...
    const bool success =
      memfault_serializer_helper_encode_metadata(e, kMemfaultEventType_Heartbeat);
...
static void prv_enable_captured_date(void) {
  ...
  const sMemfaultCurrentTime time = { .type = kMemfaultCurrentTimeType_UnixEpochTimeSec,
                                      .info = {
...
const uint8_t test_vector_with_timestamp[] = {
  ...
  'D',  0x0a, 0x64, 'm',  'a',  'i',  'n',  0x09, 0x65, '1',  '.',  '2',  '.',  '3', 0x06,
  0x66, 'e',  'v',  't',  '_',  '2',  '4',  0x01, 0x1a, 0x5e, 0x8d, 0xd6, 0xf4,
};
...
const uint8_t test_vector_with_build_id[] = {
  0xa8, 0x02, 0x01, 0x03, 0x01, 0x07, 0x69, 'D',  'A',  'A',  'B',  'B',  'C',  'C',  'D',
  'D',  0x0a, 0x64, 'm',  'a',  'i',  'n',  0x09, 0x65, '1',  '.',  '2',  '.',  '3',  0x06,
  0x66, 'e',  'v',  't',  '_',  '2',  '4',  0x0B, 0x46, 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB,
};
...
const uint8_t test_vector_with_timestamp[] = {
  0xa7, 0x02, 0x01, 0x03, 0x01, 0x0a, 0x64, 'm', 'a', 'i', 'n',  0x09, 0x65, '1',  '.',  '2',
  '.',  '3',  0x06, 0x66, 'e',  'v',  't',  '_', '2', '4', 0x01, 0x1a, 0x5e, 0x8d, 0xd6, 0xf4,
};

  #if MEMFAULT_EVENT_INCLUDE_BUILD_ID
// Optional Items: Build Id
const uint8_t test_vector_with_build_id[] = {
  0xa7, 0x02, 0x01, 0x03, 0x01, 0x0a, 0x64, 'm',  'a',  'i',  'n', 0x09,
  0x65, '1',  '.',  '2',  '.',  '3',  0x06, 0x66, 'e',  'v',  't', '_',
  '2',  '4',  0x0B, 0x46, 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB,
};
  #else
...
// memfault_platform_time_get_current is implemented. Let's run through all possible encoding
// combos.
