...
#ifndef __INCLUDE_FLASH_MAP_BACKEND_FLASH_MAP_BACKEND_H
#define __INCLUDE_FLASH_MAP_BACKEND_FLASH_MAP_BACKEND_H
...
#define COREDUMP_STORAGE_FLASH 0   

#define CONFIG_COREDUMP_STORAGE_FLASH_SLOT_PATH  "/dev/coredump"
...
static inline uint8_t mem_flash_area_get_id(const struct flash_area *fa)
{
  return fa->fa_id;
}

/****************************************************************************
 * Name: mem_flash_area_get_device_id
 *
 * Description:
...
static inline uint8_t mem_flash_area_get_device_id(const struct flash_area *fa)
{
  return fa->fa_device_id;
}

/****************************************************************************
 * Name: mem_flash_area_get_off
 *
 * Description:
...
static inline uint32_t mem_flash_area_get_off(const struct flash_area *fa)
{
  return fa->fa_off;
}

/****************************************************************************
 * Name: mem_flash_area_get_size
 *
 * Description:
...
static inline uint32_t mem_flash_area_get_size(const struct flash_area *fa)
{
  return fa->fa_size;
}

/****************************************************************************
 * Name: mem_flash_sector_get_off
 *
 * Description:
...
static inline uint32_t mem_flash_sector_get_off(const struct flash_sector *fs)
{
    return fs->fs_off;
}

/****************************************************************************
 * Name: mem_flash_sector_get_size
 *
 * Description:
...
static inline uint32_t mem_flash_sector_get_size(const struct flash_sector *fs)
{
    return fs->fs_size;
}
...
int mem_flash_area_erase(const struct flash_area *fa, uint32_t off,
                     uint32_t len);
...
#endif /* __INCLUDE_FLASH_MAP_BACKEND_FLASH_MAP_BACKEND_H */
