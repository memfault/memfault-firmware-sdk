...
MEMFAULT_WEAK void *memfault_http_client_allocate_chunk_buffer(size_t *buffer_size) {
...
MEMFAULT_WEAK void memfault_http_client_release_chunk_buffer(void *buffer) {
  free(buffer);
}
